    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Password Alterada"
                : message == ManageMessageId.SetTwoFactorSuccess ? "Fator de Autenticação Ativado"
                : message == ManageMessageId.Error ? "Ocorreu um erro."
                : message == ManageMessageId.AddPhoneSuccess ? "Numero de Telefone Adicionado"
                : message == ManageMessageId.RemovePhoneSuccess ? "Numero de Telefone Removido"
                : "";
            var idUtilizador = db.Utilizadores.Where(d => d.Username == User.Identity.Name);

            foreach (var utilizador in idUtilizador)
            {
                Session["UtizlizadorID"] = utilizador.ID;
